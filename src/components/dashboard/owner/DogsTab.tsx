...
import { Dog as DogIcon, Plus, Edit2, Trash2, Heart, Info, Camera } from 'lucide-react';
          ...
          <SheetContent className="sm:max-w-lg overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 mt-6">
              <div>
                ...
                <Input id="name" name="name" required placeholder="Rex, Bella..." className="mt-1" />
              </div>

              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="breed">Race *</Label>
                  <Input id="breed" name="breed" required placeholder="Labrador..." className="mt-1" />
                </div>
                <div>
                  <Label htmlFor="age">Âge (années)</Label>
                  <Input id="age" name="age" type="number" min="0" placeholder="3" className="mt-1" />
                </div>
              </div>

              <div>
                <Label htmlFor="weight">Poids (kg)</Label>
                <Input id="weight" name="weight" type="number" step="0.1" min="0" placeholder="25" className="mt-1" />
              </div>
