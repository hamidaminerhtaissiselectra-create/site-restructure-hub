      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-5 mb-12 md:mb-16">
          {stats.map((stat, index) => (
            ...
            >
              <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl ${stat.color === 'text-primary' ? 'bg-primary/10' : stat.color === 'text-destructive' ? 'bg-destructive/10' : stat.color === 'text-yellow-500' ? 'bg-yellow-100' : stat.color === 'text-accent' ? 'bg-accent/10' : 'bg-muted'} mb-3`}>
